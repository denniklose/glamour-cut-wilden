...
export default function Home() {
  ...
  return (
    <main id="top">
      ...
      <section className="service-intro" aria-labelledby="service-intro-title"><div className="service-intro-composition"><p className="section-kicker">Beratung · Schnitt · Farbe</p><h2 className="service-intro-title" id="service-intro-title"><span>{introClaim.lead}</span><em className="heading-accent">{introClaim.accent}</em></h2><Link href={bookingHref}>{bookingLabel} <span aria-hidden="true">→</span></Link></div></section>
